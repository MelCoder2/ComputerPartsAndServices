...
class BankDetailsDialog(QDialog):
    def __init__(self, parent):
        ...
        self.bank_name.setPlaceholderText("e.g. BDO, BPI, Metrobank")
    ...
    def get_bank_details(self):
        return self.bank_name.text(), self.account_num.text()
...
class UserView(QMainWindow):
    ...
    def init_orders_tab(self):
        ...
        btn.setStyleSheet("""
            ...
            QPushButton:hover { background: #f1f5f9; }
        """)
        btn.clicked.connect(self.refresh_orders)
    ...
    def init_my_bookings_tab(self):
        ...
        btn.setStyleSheet("""
            ...
            QPushButton:hover { background: #f1f5f9; }
        """)
        btn.clicked.connect(self.refresh_my_bookings)
    ...
    def refresh_orders(self):
        ...
        sales = self.controller.get_order_history()
    ...
    def refresh_my_bookings(self):
        ...
        rows = self.controller.get_my_bookings()
